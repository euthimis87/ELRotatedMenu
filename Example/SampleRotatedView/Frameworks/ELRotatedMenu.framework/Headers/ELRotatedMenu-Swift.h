...
@class UIColor;
@class UIImage;
@protocol ELRotatedMenuDelegate;
@protocol UIViewControllerTransitionCoordinator;
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC13ELRotatedMenu13ELRotatedMenu")
@interface ELRotatedMenu : UIViewController
...
@property (nonatomic, strong) UIImage * _Null_unspecified menuImage;
/// The image of closing menu button
@property (nonatomic, strong) UIImage * _Null_unspecified closeMenuImage;
...
@property (nonatomic) BOOL extendFrontViewHeight;
@property (nonatomic, weak) id <ELRotatedMenuDelegate> _Nullable delegate;
- (void)viewDidLoad;
...
SWIFT_PROTOCOL("_TtP13ELRotatedMenu21ELRotatedMenuDelegate_")
@protocol ELRotatedMenuDelegate <NSObject>
@optional
- (void)willRevealMenu;
- (void)willHideMenu;
@end
...
SWIFT_CLASS("_TtC13ELRotatedMenu18ELRotatedMenuSegue")
@interface ELRotatedMenuSegue : UIStoryboardSegue
- (void)perform;
...
@interface UIView (SWIFT_EXTENSION(ELRotatedMenu))
@end
...
@interface UIViewController (SWIFT_EXTENSION(ELRotatedMenu))
@end
